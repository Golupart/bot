...
# ===== CONFIGURATION =====
BOT_TOKEN = "8594216898:AAEAAvlHl-yfQMaDbB-sxRZl1N0SRuF2H5g"  # Change this!
ADMIN_IDS = [7820814565]  # Change to your Telegram ID
CHANNEL_USERNAME = "@POWERXBOYZ"  # Your channel
...
def handle_photo(message):
    ...
    bot.reply_to(
        message,
        f"✅ *Feedback Received!*\n\n"
        f"Thank you @{username} for your support!\n"
        f"💪 Keep attacking with @PowerxBoyz!",
        parse_mode="Markdown"
    )
